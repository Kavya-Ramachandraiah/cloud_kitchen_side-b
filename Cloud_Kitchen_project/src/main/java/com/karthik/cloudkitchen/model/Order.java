...
public class Order {
    ...
    public Order(List<String> dishName, String catererName, LocalDate deliveryDate, int numberOfPeople, User user) {
    ...
    public Order(String dishName2, String catererName2, LocalDate deliveryDate2, int numberOfPeople2) {
